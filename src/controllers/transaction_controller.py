...
class ReportController:
    ...
    async def create_draft_report(
        ...
        result = await ReportService.create_draft_report(
            db, transaction_id, employee_id, description, start_time, end_time, image_data
        )
    ...
    async def get_all_reports(
        ...
        result = ReportService.get_all_reports(db, page, per_page, search, status, transaction_id, karyawan_id)
    ...
    async def get_pending_reports(
        ...
        result = ReportService.get_pending_reports(db, page, per_page)
        return handle_response(
            200,
            MESSAGE_CODE.SUCCESS,
    ...
    async def submit_report(
        ...
        return handle_response(200, MESSAGE_CODE.SUCCESS, "Report submitted for approval", result)
